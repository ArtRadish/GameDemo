...
public class FlyingKickAttack : MonoBehaviour,IAttack
{
    private const string kIsFlyingKick = "IsFlyingKick";
    ...
    private void Start()
    {
        ...
        AttackManager.Instance.attacks.Add((int)AttackType.SKILLATTACK,this);
    }
    ...
    {
        _animator.SetBool(kIsFlyingKick, _isAttack);
    }
