...
public class FlipAttack : MonoBehaviour,IAttack
{
    private const string kIsFlip = "IsFlip";
    ...
    private void Start()
    {
        ...
        AttackManager.Instance.attacks.Add((int)AttackType.FLIPATTACK,this);
    }
    ...
    {
        _animator.SetBool(kIsFlip, _isAttack);
    }
